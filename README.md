...
| FIREBASE_SERVICE_ACCOUNT_JSON | Firebase service account JSON string | (required) |
...
fly secrets set API_KEY=... UPSTASH_REDIS_REST_URL=... UPSTASH_REDIS_REST_TOKEN=... FIREBASE_SERVICE_ACCOUNT_JSON='{"type":"service_account","project_id":"...","private_key":"...","client_email":"..."}'
fly deploy
```
